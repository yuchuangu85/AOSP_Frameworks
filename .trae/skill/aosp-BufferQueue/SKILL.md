---
name: aosp-bufferqueue
description: AOSP BufferQueue 专项分析 Skill。用于分析 Android 图形栈中 BufferQueue / GraphicBuffer / BufferSlot / dequeueBuffer / queueBuffer / acquireBuffer / releaseBuffer / sync fence / producer-consumer 协作机制，定位黑屏、花屏、 卡顿、掉帧、Buffer 积压、消费者阻塞、生产者阻塞、Surface / BLAST / SurfaceFlinger 交互异常等问题。适用于源码分析、时序还原、trace 诊断、 dumpsys 解析、性能瓶颈定位与架构理解。
---
