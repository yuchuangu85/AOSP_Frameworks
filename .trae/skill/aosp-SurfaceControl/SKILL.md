---
name: aosp-surfacecontrol
description: 用于分析 Android AOSP 中 SurfaceControl 相关源码、事务机制、图层树操作、窗口与图形系统交互、 BLASTBufferQueue / SurfaceControl.Transaction / LayerState / SurfaceComposerClient / SurfaceFlinger 跨层调用链。适用于分析窗口变更、图层创建销毁、显示事务提交、同步机制、动画/旋转/截图/录屏、 以及 SurfaceControl 引发的显示异常、闪屏、黑屏、残影、层级错误、同步错乱、性能问题。
---
