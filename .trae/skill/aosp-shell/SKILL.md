---
name: aosp-shell
description: 用于分析 Android AOSP 中 Shell / WM Shell / SystemUI Shell 相关源码与运行机制，覆盖 Task、Transition、SplitScreen、PIP、Desktop Mode、Recents、Back Navigation、DisplayArea 协作、WindowContainer 关系、动画与状态流转。适用于源码阅读、架构理解、行为解释、性能问题定位、窗口切换异常、分屏/PIP异常、Transition链路分析等场景。
---
