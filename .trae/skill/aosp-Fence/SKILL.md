---
name: aosp-fence
description: 用于分析 Android AOSP 图形栈中的 Fence 同步机制，覆盖 acquireFence / releaseFence / presentFence / retireFence / timeline / sync_file / dma_fence / BufferQueue / SurfaceFlinger / HWC / DRM 全链路。适用于卡顿、掉帧、黑屏、花屏、显示延迟、Buffer 堆积、Fence wait 超时、GPU/HWC 合成异常、FrameTimeline 时序异常等问题的源码分析、trace 分析、日志分析与根因定位。
---
