---
name: aosp-animation
description: 用于分析 AOSP 动画系统（App / View / Window / Shell / Surface / SurfaceFlinger / Transition / Animator / Choreographer / VSYNC / RenderThread）源码、调用链、时序、状态流转与性能问题。适用于启动动画、Activity/Task 切换、窗口动画、属性动画、View 动画、Insets/IME 动画、Shell Transition、RemoteAnimation、BLAST/Leash 过渡、掉帧卡顿、动画不生效、闪烁抖动、黑屏白屏、层级错乱、同步失配等问题的系统级分析。
---
