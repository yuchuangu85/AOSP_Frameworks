---
name: aosp-surfaceflinger
description: 用于分析 Android AOSP 中 SurfaceFlinger 的源码实现、事务处理、Layer 生命周期、Buffer latch、 CompositionEngine、VSync 调度、HWC 合成、显示输出链路与性能问题。适用于定位黑屏、闪屏、 花屏、残影、图层错乱、事务不生效、Buffer 不一致、合成异常、掉帧卡顿、显示时序异常等问题。
---
