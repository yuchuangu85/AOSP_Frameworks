---
name: aosp-transaction
description: 用于分析 AOSP 中 Transaction 机制的源码实现、跨层调用链、时序过程与问题根因，覆盖 WindowContainerTransaction、SurfaceControl.Transaction、ClientTransaction、Layer/Display Transaction、BLAST/BufferStateLayer 相关事务提交路径。适用于源码阅读、系统行为解释、窗口切换问题、画面更新异常、事务合并/延迟/丢失问题、性能优化与稳定性分析。
---
